    ...
    <>
      ...
      <section style={{ padding: "60px 0", background: "var(--bg-primary)", minHeight: "50vh" }}>
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          {!user ? (
            <div style={{ textAlign: "center", padding: 40, background: "var(--bg-glass)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border)" }}>
              <h3 style={{ marginBottom: 20, color: "var(--text-primary)" }}>Please login to submit or view complaints.</h3>
